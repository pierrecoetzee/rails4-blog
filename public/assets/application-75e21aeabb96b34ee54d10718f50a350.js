...
// source: app/assets/javascripts/templates/article/create.html.haml

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("article/create.html", "<div class='modal' id='createModal' role='dialog'>\n  <div class='modal-dialog'>\n    <div class='modal-content'>\n      <div class='modal-header'>\n        <button class='close' ng-click='createModal.hide()' type='button'>×</button>\n        <h4 class='modal-title'>Article management</h4>\n      </div>\n      <div class='modal-body'>\n        <form class='form-horizontal' ng-submit='save()' novalidate=''>\n          <ng-include src=\"'article/form.html'\"></ng-include>\n          <button class='btn btn-primary' type='submit'>save</button>\n        </form>\n      </div>\n    </div>\n  </div>\n</div>")
}]);
...
angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("article/form.html", "<p>\n  Article\n</p>\n<p>\n  <label for='title'>Title</label>\n  <br>\n  <input name='title' ng-model='blogs.selectedArticle.title' required type='text'>\n</p>\n<p>\n  <label for='text'>Text</label>\n  <br>\n  <textarea cols='40' name='text' ng-model='blogs.selectedArticle.text' rows='3'></textarea>\n</p>\n<ng-include src=\"'comment/form.html'\"></ng-include>")
}]);
...
angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("comment/form.html", "<div class='comment-section' ng-repeat='comment in blogs.selectedArticle.comments'>\n  <textarea>{{comment.body}}</textarea>\n</div>")
}]);
...
app.service('ArticleService', function (Article, $q) {
...
app.controller('ArticleListCtrl', function($scope, $modal, ArticleService){
  ...
  $scope.save = function () {
    ...
    $scope.blogs.updateArticle($scope.createModal, $scope.blogs.selectedArticle)
